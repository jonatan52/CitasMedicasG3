...
public class EspecialidadController {
    ...
    public ResponseEntity<Especialidad> editar(@RequestBody Especialidad especialidad){
        Especialidad obj = especialidadService.findById(especialidad.getIdEspecialidad());
        if(obj!=null) {
            obj.setIdEspecialidad(especialidad.getIdEspecialidad());
            obj.setNombreEspecialidad(especialidad.getNombreEspecialidad());
